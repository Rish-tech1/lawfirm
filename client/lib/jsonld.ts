...
export function organisationSchema(): JsonLdObject {
  return {
    ...
    alternateName: [
      site.shortName,
      'Singla Law Firm',
      'Singla and Singla Advocates',
      'Top Law Firm in Delhi NCR',
      'Best Advocates in Karkardooma Court',
    ],
    ...
    memberOf: [
      ...
      {
        '@type': 'Organization',
        name: 'Shahdara Bar Association, Karkardooma Court',
      },
      {
        '@type': 'Organization',
    ...
    knowsAbout: [
      'Top Law Firm in Delhi NCR',
      'Karkardooma Court Advocate Chamber',
      'Criminal Law and Bail Applications',
      'FIR Quashing under Section 482 CrPC',
      'Matrimonial Disputes and 498A IPC',
      'Mutual Consent Divorce and Contested Divorce',
      'Civil Litigation and Recovery Suits',
      'Section 138 Negotiable Instruments Act (Cheque Bounce)',
      'Property Due Diligence and Title Verification',
      'Partition and Declaration Suits',
      'Commercial Arbitration and Dispute Resolution',
      'Corporate Law and Contract Drafting',
      'Consumer Protection Disputes',
      'Cyber Crime Legal Defence',
      'Taxation and Income Tax Appeals',
      'Delhi High Court Writ Petitions and Appeals',
      'Supreme Court of India Special Leave Petitions',
    ],
    contactPoint: [
      {
        '@type': 'ContactPoint',
        contactType: 'Client enquiries & consultations',
        telephone: site.phone.primaryHref,
        email: site.email.general,
      ...
      {
        '@type': 'ContactPoint',
        contactType: 'Emergency Criminal & Custody Matters',
        telephone: site.phone.secondaryHref,
        email: site.email.general,
        areaServed: site.address.countryCode,
...
export function websiteSchema(): JsonLdObject {
  return {
    ...
    '@id': WEBSITE_ID,
    url: site.url,
    name: `${site.name} - Top Law Firm in Delhi NCR`,
    alternateName: 'Singla & Singla Advocates Delhi NCR',
    description: site.description,
    inLanguage: 'en-IN',
